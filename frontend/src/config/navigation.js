export const navigationItems = [
  ...
  { id: 'discover', to: '/specimens', label: 'Observações', icon: 'search', mobilePriority: 3, match: (path) => path === '/specimens' || (/^\/specimens\/[^/]+$/.test(path) && path !== '/specimens/new') },
  { id: 'taxonomy', to: '/taxonomy', label: 'Taxonomia', icon: 'taxonomy', mobilePriority: 4, match: (path) => path === '/taxonomy' || path.startsWith('/taxonomy/') },
];
