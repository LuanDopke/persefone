---
name: speckit-tasks-to-project-publish
description: Publish the current feature's tasks.md to a GitHub Project (v2) kanban
  board
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: tasks-to-project:commands/speckit.tasks-to-project.publish.md
---
