---
name: speckit-tasks-to-project-sync
description: Reconcile the current feature's tasks.md against existing cards on a
  GitHub Project (v2) board
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: tasks-to-project:commands/speckit.tasks-to-project.sync.md
---
